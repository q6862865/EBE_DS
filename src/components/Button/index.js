...
const StyledBase = styled.button`
  ...
  color: #fff;
  background-color: ${props => props.theme.brandPrimary || '#000'};
  font-size: 14px;
  font-style: normal;
  font-stretch: normal;
  ...
  &:hover {
    ...
    color: ${props => props.theme.brandPrimary || '#FFF'};
    border-color: ${props => props.theme.brandPrimary || '#C2A974'};
...
function Button({ className, color, children, fullWidth, size, disabled, href, ...props }) {
  if (href) {
